...
def vc_single(input_audio, f0_up_key, f0_file, f0_method, file_index, index_rate, filter_radius, resample_sr, rms_mix_rate, protect, tgt_sr, net_g, vc, hubert_model, version, cpt, crepe_hop_length, sid = None, semb = None, inter=None, function="infer_sid", formant_shift=1, formant_to_shift=0):
    ...
    audio_opt=vc.pipeline2(
        ...
        formant_to_shift=formant_to_shift,
    )
    print(times)
    return audio_opt
...
device = "cuda:0"
is_half = True
model_path = "C:/Users/lundb/Documents/Other/Music/RVC-beta/RVC-beta-v2-0528/weights/VCTK-dv-many-per-speaker-individual-formants_e55_s163405.pth" #merged3_e185_s8880.pth
...
use_d_vector = True
trained_se_path = None#"C:/Users/lundb/Documents/Other/Music/RVC-beta/RVC-beta-v2-0528/logs/VCTK-coqui-setup/SE_207970.pth"#"C:/Users/lundb/Documents/Other/Music/RVC-beta/RVC-beta-v2-0528/logs/NUSR8E-formant-experiment-all-se-backprop/SE_23500.pth"#
...
def generate(inp, function="infer_sid", f0up_key = 0, formant_shift=1, formant_to_shift=0, output_path = "test.wav"):
    print("Started")
    device_config = Config(device, is_half)
...
def get_average_pitch(file):
    from extract_f0_simple import FeatureInput

    audio = load_audio(file,16000)
    featureInput = FeatureInput()

    f0 = featureInput.compute_f0_from_audio(audio=audio, f0_method="mangio-crepe", crepe_hop_length=128)
    ...
    filtered_f0 = f0[(f0 >= lower_bound) & (f0 <= upper_bound)]
    
    mean_f0 = np.mean(filtered_f0)
    median_f0 = np.median(filtered_f0)

    return (mean_f0 + median_f0)/2

def calculate_pitch_diff(f0_1, f0_2):
    return int(12 * np.log2(f0_2 / f0_1))
...
generate(d_vector, function="infer_semb", f0up_key=8, formant_shift=1.2, formant_to_shift=0, output_path=f"test_stuff/VCTK/VCTK-dv-many-per-speaker-individual-formants_e55_sandro-sid__f+8_1.2.wav")
...
# for i in range(12):
#     d_vector = np.load(f"C:/Users/lundb/Documents/Other/Music/RVC-beta/RVC-beta-v2-0528/logs/NUSR8E-formant-experiment-all-512-formants/4_d_vectors/{i}.npy")
#     generate(d_vector, function="infer_semb", f0up_key=0, formant_shift=1, output_path=f"test_stuff/dv-tests/VCTK-coqui-setup_e70_sid-{i}.wav")
...
#     generate(d_vector, function="infer_semb", f0up_key=0, formant_shift=1, output_path=f"test_stuff/dv-tests/VCTK-formants-dv-mic1_e60-SOS-sid-{i}.wav")
...
# for i in range(0,5):
#     generate(d_vector, function="infer_semb", f0up_key=0, formant_shift=0.7, formant_to_shift=i, output_path=f"test_stuff/VCTK/VCTK-dv-many-per-speaker-individual-formants_e55_f{i}-0.7-sid-0.wav")
#     generate(d_vector, function="infer_semb", f0up_key=0, formant_shift=1.3, formant_to_shift=i, output_path=f"test_stuff/VCTK/VCTK-dv-many-per-speaker-individual-formants_e55_f{i}-1.3-sid-0.wav")
...
# generate(87, function="infer_sid", f0up_key=0, formant_shift=1, output_path="test_stuff/109-voices-87.wav")
...
#     generate(1, function="infer_sid", f0up_key=0, formant_shift=1.3, formant_to_shift=i, output_path=f"test_stuff/formant_test_encoder_generator_f{i}-1.3-sid1.wav")
