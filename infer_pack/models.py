...
class TextEncoder768(nn.Module):
    def __init__(
        ...
        if f0 == True:
            self.emb_pitch = nn.Embedding(256, hidden_channels)  # pitch 256
            self.emb_formant1 = nn.Embedding(2048, hidden_channels) #nn.Linear(1, hidden_channels)
            self.emb_formant2 = nn.Embedding(2048, hidden_channels) #nn.Linear(1, hidden_channels)
            self.emb_formant3 = nn.Embedding(2048, hidden_channels) #nn.Linear(1, hidden_channels)
            self.emb_formant4 = nn.Embedding(2048, hidden_channels) #nn.Linear(1, hidden_channels)
