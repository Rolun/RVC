...
class TextEncoder768(nn.Module):
    ...
    def forward(self, phone, pitch, lengths, coarse_formants = (None,None,None,None,None)):
        if pitch == None:
            x = self.emb_phone(phone)
        else:
            x = self.emb_phone(phone) + self.emb_pitch(pitch)
        ...
        if coarse_formants[0] != None:
            ...
            # + self.emb_formant5(coarse_formants[4])
...
class SynthesizerTrnMs768NSFsid(nn.Module):
    ...
    def forward(
        ...
        # f4 = commons.slice_segments2(f4, ids_slice, self.segment_size)
        # f5 = commons.slice_segments2(f5, ids_slice, self.segment_size)
